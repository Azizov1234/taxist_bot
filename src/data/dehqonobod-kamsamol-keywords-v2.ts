...
export const DK_V2_TEST_CASES: Array<{ text: string; expected: DkV2DecisionCategory }> = [
  ...
  { text: "Gulistonga 1 kishi bor", expected: "PASSENGER_LEAD" },
  { text: "Kamsamoldan gulistonga taksi kerak 2kishi", expected: "PASSENGER_LEAD" },
  { text: "Kamsamolga 1kishi bor", expected: "PASSENGER_LEAD" },
  { text: "Gulistondan kamsamolga 1 kishi bor", expected: "PASSENGER_LEAD" },
  { text: "Kamsamoldan Gulistonga 3kiwi bor", expected: "PASSENGER_LEAD" },
  { text: "Gylistonga 1kishu bor", expected: "PASSENGER_LEAD" },
  { text: "Камсамолдан гулистонга 1 киши срочно", expected: "PASSENGER_LEAD" },
  { text: "Zaryadan shaharga taksi bormi", expected: "PASSENGER_LEAD" },
  { text: "Toshkentdan Kamsamolga taksi bormi", expected: "PASSENGER_LEAD" },
  { text: "ketishim kere srochna", expected: "PASSENGER_LEAD" },
  { text: "Kamsamoldan gulistonga bosh moshin kerak zakaz", expected: "PASSENGER_LEAD" },
...
const PASSENGER_MANUAL: Array<{ phrase: string; weight: number }> = [
  ...
  { phrase: "srochna", weight: 8 },
  { phrase: "srochno", weight: 8 },
  { phrase: "srowna", weight: 8 },
  { phrase: "srowno", weight: 8 },
  { phrase: "srochna kerak", weight: 10 },
  { phrase: "srochno kerak", weight: 10 },
  { phrase: "srochna yuramiz", weight: 9 },
  { phrase: "shoshilinch", weight: 8 },
  { phrase: "shoshilinch kerak", weight: 10 },
  { phrase: "ketishim kere", weight: 10 },
  { phrase: "ketishim kk", weight: 9 },
  { phrase: "borishim kere", weight: 10 },
  { phrase: "hozrga", weight: 8 },
  { phrase: "hozr kerak", weight: 8 },
  { phrase: "faqat tez", weight: 9 },
  { phrase: "1kiwi bor", weight: 10 },
  { phrase: "2kiwi bor", weight: 10 },
  { phrase: "3kiwi bor", weight: 10 },
  { phrase: "1kishu bor", weight: 10 },
  { phrase: "1kishi bor", weight: 10 },
  { phrase: "2kishi bor", weight: 10 },
  { phrase: "3kishi bor", weight: 10 },
  { phrase: "4kishi bor", weight: 10 },
  { phrase: "1odam bor", weight: 10 },
  { phrase: "2odam bor", weight: 10 },
  { phrase: "3odam bor", weight: 10 },
  { phrase: "2 ta odam bor", weight: 10 },
  { phrase: "3 ta odam bor", weight: 10 },
  { phrase: "gulistonga 1 kishi bor", weight: 10 },
  { phrase: "gulistonga 2 kishi bor", weight: 10 },
  { phrase: "kamsamolga 1 kishi bor", weight: 10 },
  { phrase: "kamsamolga 1kishi bor", weight: 10 },
  { phrase: "kamsamolga 2 kishi bor", weight: 10 },
  { phrase: "kamsamolga 1 odam bor", weight: 10 },
  { phrase: "kamsamolga 1odam bor", weight: 10 },
  { phrase: "kamsamoldan gulistonga 1 kishi bor", weight: 10 },
  { phrase: "kamsamoldan gulistonga 2 kishi bor", weight: 10 },
  { phrase: "kamsamoldan gulistonga 3 kishi bor", weight: 10 },
  { phrase: "kamsamoldan gulistonga 4 kishi bor", weight: 10 },
  { phrase: "kamsamoldan gulistonga taksi kerak", weight: 10 },
  { phrase: "kamsamoldan gulistonga taksi kere", weight: 10 },
  { phrase: "kamsamoldan gulistonga taxi kerak", weight: 10 },
  { phrase: "kamsamoldan gulistonga taksi bormi", weight: 10 },
  { phrase: "gulistondan kamsamolga 1 kishi bor", weight: 10 },
  { phrase: "gulistondan kamsamolga 2 kishi bor", weight: 10 },
  { phrase: "gulistondan kamsamolga taksi kerak", weight: 10 },
  { phrase: "gulistondan kamsamolga ketish kerak", weight: 10 },
  { phrase: "kamsamoldan gulistonga bosh moshin kerak", weight: 10 },
  { phrase: "kamsamoldan gulistonga bo'sh moshin kerak", weight: 10 },
  { phrase: "kamsamoldan gulistonga konditsionerli moshin kerak", weight: 10 },
  { phrase: "kanditsioneri bor moshina kerak", weight: 10 },
  { phrase: "kanisanerli bosh moshin kerak", weight: 10 },
  { phrase: "bosh moshin kerak", weight: 10 },
  { phrase: "bush moshin kerak", weight: 10 },
  { phrase: "bo'sh mashina kerak", weight: 10 },
  { phrase: "zakaz", weight: 8 },
  { phrase: "zakaz kerak", weight: 9 },
  { phrase: "uydan opketish kerak", weight: 10 },
  { phrase: "uydan opketish kk", weight: 10 },
  { phrase: "uydan obketish kerak", weight: 10 },
  { phrase: "uydan olib ketish kerak", weight: 10 },
  { phrase: "uydan opketish kerak", weight: 10 },
  { phrase: "opketish kerak", weight: 10 },
  { phrase: "oborib olib kelishga", weight: 9 },
  { phrase: "oborib olib keliwga", weight: 9 },
  { phrase: "kamsamoldan shaharga taksi bormi", weight: 10 },
  { phrase: "kamsamoldan waxarga 1 kishi", weight: 10 },
  { phrase: "kamsamoldan shaharga 1 kishi", weight: 10 },
  { phrase: "zaryadan shaharga taksi bormi", weight: 10 },
  { phrase: "zaripdordan kamsamolga 2 ta odam bor", weight: 10 },
  { phrase: "toshkentdan kamsamolga 1 kishi", weight: 10 },
  { phrase: "toshkentdan kamsamolga taksi", weight: 10 },
  { phrase: "toshkentdan kamsamolga taksi kerak", weight: 10 },
  { phrase: "toshkentdan kamsamolga pochta bor", weight: 8 },
  { phrase: "gylistonga 1 kishi bor", weight: 10 },
  { phrase: "gylistonga 1kishu bor", weight: 10 },
  { phrase: "kamsamoldan gulistonga 3kiwi bor", weight: 10 },
  { phrase: "metroda km bor", weight: 8 },
  { phrase: "assalomu alaykum kamsamoldan gulistonga taksi kerak", weight: 10 },
  { phrase: "ohangaronga damas 2ta kerak", weight: 10 },
  { phrase: "damas kerak", weight: 9 },
  { phrase: "damas 2ta kerak", weight: 10 },
  { phrase: "gulistonga 2 kishi det bolga", weight: 9 },
  { phrase: "baradan pochta bor", weight: 8 },
  { phrase: "pochta bor srochna", weight: 8 }
];
...
const PASSENGER_CYRILLIC: Array<{ phrase: string; weight: number }> = [
  ...
  { phrase: "срочно", weight: 9 },
  { phrase: "срочна", weight: 9 },
  { phrase: "камсамолга 1 киши бор", weight: 10 },
  { phrase: "гулистонга 1 киши бор", weight: 10 },
  { phrase: "гулистонга 2 киши бор", weight: 10 },
  { phrase: "гулистондан камсамолга 1 киши бор", weight: 10 },
  { phrase: "камсамолдан гулистонга 1 киши", weight: 10 },
  { phrase: "камсамолдан гулистонга 1 киши срочно", weight: 10 },
  { phrase: "камсамолдан гулистонга 2 киши бор", weight: 10 },
  { phrase: "камсамолдан гулистонга такси керак", weight: 10 },
  { phrase: "уйдан опкетиш керак", weight: 10 },
  { phrase: "уйдан опкетиш кк", weight: 10 },
  { phrase: "такси борми", weight: 10 },
  { phrase: "такси кере", weight: 9 },
  { phrase: "кетишим керак", weight: 10 },
  { phrase: "кетишим кере", weight: 10 },
  { phrase: "буш мошин керак", weight: 10 },
  { phrase: "бўш мошин керак", weight: 10 },
  { phrase: "тошкентдан камсамолга 1 киши", weight: 10 },
  { phrase: "тошкентдан камсамолга такси", weight: 10 },
  { phrase: "зарядан шаҳарга такси борми", weight: 10 },
  { phrase: "3 киши бор", weight: 10 },
  { phrase: "4 киши бор", weight: 10 }
];
...
const PASSENGER_ROUTE_TEMPLATES = [
  ...
  "{from}dan {to}ga 4 kishi bor",
  "{from}dan {to}ga 1 odam bor",
  "{from}dan {to}ga 2 odam bor",
  "{from}dan {to}ga taxi kerak",
  "{from}dan {to}ga taksi kerak",
  "{from}dan {to}ga taxi kere",
  "{from}dan {to}ga taksi kere",
  "{from}dan {to}ga taxi bormi",
  "{from}dan {to}ga taksi bormi",
  "{from}dan {to}ga ketish kerak",
  "{from}dan {to}ga ketish kere",
  "{from}dan {to}ga borish kerak",
  "{from}dan {to}ga borish kere",
  "{from}dan {to}ga kim ketadi",
  "{from}dan {to}ga joy bormi",
  "{from}dan {to}ga srochna",
  "{from}dan {to}ga srochno kerak",
  "{from}dan {to}ga srochna kerak",
  "{from}dan {to}ga opketish kerak",
  "{from}dan {to}ga uydan opketish kerak",
  "{from}dan {to}ga bosh moshin kerak",
  "{from}dan {to}ga bo'sh moshin kerak",
  "{from}dan {to}ga konditsionerli moshin kerak"
] as const;
...
const REGEX_KEYWORDS: Array<{ category: KeywordCategory; pattern: string; weight: number }> = [
  ...
  {
    category: KeywordCategory.PASSENGER,
    pattern: "\\b\\d+\\s*(?:kishi|kiwi|kishu|odam|ta)\\s*(?:bor|бор)\\b",
    weight: 10
  },
  { category: KeywordCategory.PASSENGER, pattern: "\\b\\d+(?:kishi|kiwi|kishu|odam)\\s*(?:bor|бор)?\\b", weight: 10 },
  {
    category: KeywordCategory.PASSENGER,
    pattern: "\\b(?:kamsamol|komsomol|kamsamolga|kamsamoldan|камсамол|комсамол)\\w*\\b.{0,50}\\b(?:bor|kerak|kere|bormi|бор|керак|кере)\\b",
    weight: 9
  },
  {
    category: KeywordCategory.PASSENGER,
    pattern: "\\b(?:guliston|gyliston|гулистон|гулистонга|гулистондан)\\w*\\b.{0,50}\\b(?:bor|kerak|kere|kishi|киши|odam|одам)\\b",
    weight: 9
  },
  { category: KeywordCategory.PASSENGER, pattern: "\\b(?:srochna|srochno|srowna|srowno|срочно|срочна|shoshilinch)\\b", weight: 9 },
  {
    category: KeywordCategory.PASSENGER,
    pattern: "\\b(?:ketishim|borishim|кетишим|боришим)\\s*(?:kerak|kere|kk|керак|кере|кк)\\b",
    weight: 10
  },
  {
    category: KeywordCategory.PASSENGER,
    pattern: "\\b(?:taksi|taxi|такси)\\s*(?:kerak|kere|bormi|керак|кере|борми)\\b",
    weight: 10
  },
  {
    category: KeywordCategory.PASSENGER,
    pattern: "\\b(?:uydan|uydan|уйдан)\\s*(?:op|ob)\\s*(?:ketish|borish|ketiw|boriw)\\s*(?:kerak|kere|kk|керак|кк)?\\b",
    weight: 10
  },
  {
    category: KeywordCategory.PASSENGER,
    pattern: "\\b(?:bosh|bo'?sh|bush|буш|бўш)\\s*(?:moshin|mashina|мошин|машина)\\s*(?:kerak|kere|керак|кере)?\\b",
    weight: 10
  },
  {
    category: KeywordCategory.PASSENGER,
    pattern: "\\b(?:zarya|zaripdor|zaryadan|zaripdordan|заря|зарипдор)\\w*\\b.{0,40}\\b(?:taksi|bor|kerak|kishi|odam)\\b",
    weight: 9
  },
  {
    category: KeywordCategory.PASSENGER,
    pattern: "\\b(?:toshkent|tashkent|тошкент|ташкент)\\w*\\b.{0,40}\\b(?:kamsamol|камсамол|taksi|kishi|odam)\\b",
    weight: 9
  }
];
