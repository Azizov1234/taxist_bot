...
const DRIVER_MANUAL_EXPANSION: Array<{ phrase: string; weight: number }> = [
  ...
  { phrase: "taxsi xizmati", weight: 10 },
  { phrase: "taxi hizmati", weight: 10 },
  { phrase: "taksi hizmati", weight: 10 },
  { phrase: "taxsi hizmati", weight: 10 },
  ...
  { phrase: "bo'sh taxi bor", weight: 10 },
  { phrase: "bosh taxi bor", weight: 10 },
  { phrase: "bo'sh taxsi bor", weight: 10 },
  { phrase: "bosh taxsi bor", weight: 10 },
  { phrase: "bo'sh moshin", weight: 9 },
  { phrase: "bosh moshin", weight: 9 },
  { phrase: "mashin bor", weight: 10 },
  { phrase: "moshin bor", weight: 10 },
  { phrase: "mowina bor", weight: 10 },
  { phrase: "mowin bor", weight: 10 },
  { phrase: "mawina bor", weight: 10 },
  { phrase: "mawin bor", weight: 10 },
...
function generateRegexKeywords(): void {
  const patterns: Array<{ category: KeywordCategory; pattern: string; weight: number }> = [
    ...
    {
      category: KeywordCategory.DRIVER,
      pattern: "\\b(?:taxi|taksi|taxsi)\\b.{0,30}\\bbor\\b.{0,30}\\b(?:kishi|odam)\\b(?:.{0,20}\\bbo'?lsa\\b)?(?:.{0,30}\\b(?:olib|ob)\\s*ket(?:aman|amiz|amz)\\b)",
      weight: 10
    },
    { category: KeywordCategory.PASSENGER, pattern: "\\b(?:taxi|taksi|taxsi|taxii|taksii|takis)\\s*(?:kk|krk|kerak|kere)\\b", weight: 9 },
